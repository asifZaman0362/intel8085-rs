...
;(A/D) 2 8-bit numbers
     ...
     LDA 5001H      ;Load value of divisor from address 5001 
     MOV D, A       ;move divisor from A to D

     LDA 5000H      ;Load value of dividend from address 5000 
...
Div: INR C          ;Increment quotient
     ...
     STA 5002H      ;Store remainder at memory location 5002

     MOV A, C       ;copy content of C (quotient) into A
     STA 5003H      ;Store quotient at location 5003
