...
;(BxD) 2 8-bit numbers
   ...
   Loop: JZ Exit      ;if Zero, jump to exit
         ADD D        ;Add D to A
         JNC NOC  ;if carry is not generated, jump to label NoCarry
         INR C        ;if carry is generated, increment C
NOC:     DCR B        ;decrement B
         JMP Loop     ;Jump to label Loop
         
   Exit: STA 5003H    ;store content of A (lower order of result) at memory location 5003
